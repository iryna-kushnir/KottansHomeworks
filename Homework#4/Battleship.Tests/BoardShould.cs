...
namespace Battleship.Tests
{
    ...
    public class BoardShould
    {
        ...
        public void ThrowShipsOverlapException_WhenShipsOverlap()
        {
            ...
            Assert.Throws<ShipOverlapException>(() => { board.Add(new PatrolBoat(1, 1)); },
                "Ship A1x1- overlaps with A1x1-");
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => { board.Add(new Submarine(x, y, direction)); });
        }
        ...
        public void ThrowBoardIsNotReadyWithoutAllShips_DuringValidation(string message, params string[] ships)
        {
            ...
            Assert.Throws<BoardIsNotReadyException>(() => { board.Validate(); }, message);
        }
